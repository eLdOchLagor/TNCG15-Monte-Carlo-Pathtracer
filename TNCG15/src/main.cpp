...
int main()
{
	...
	Camera mainCamera(glm::vec3(0,0,0), glm::vec3(1,0,0), glm::vec3(0,0,1), 3.14159f/4.0f,(float)imageWidth/imageHeight); //TODO: fixa så att aspectRatio och fov beräknas i constructorn istället
	...
	Rectangle* wall3 = new Rectangle(glm::vec3(10, -6, 5), glm::vec3(13, 0, 5), glm::vec3(13, 0, -5), glm::vec3(10, -6, -5), glm::vec3(0, 255, 0)); //Målvägg höger //looking at
	...
	Rectangle* wall6 = new Rectangle(glm::vec3(10, 6, 5), glm::vec3(10, 6, -5), glm::vec3(13, 0, -5), glm::vec3(13, 0, 5), glm::vec3(255, 0, 0)); //Målvägg vänster //looking at
