...
int main()
{
	...
	Tetrahedron* test = new Tetrahedron(glm::dvec3(5, 0, 3), glm::dvec3(4, 0, 1), glm::dvec3(6, -1, 1), glm::dvec3(6, 1, 1), glm::dvec3(0, 0, 1), 2, 0);
	...
	// Floor ----------------------------------------------------------------------------------------
	Rectangle* floor1 = new Rectangle(glm::dvec3(10,6,-5), glm::dvec3(0,6,-5), glm::dvec3(0,-6,-5), glm::dvec3(10,-6,-5),glm::dvec3(1.0, 0.0, 0.0), 2, 0,true);
	...
	Rectangle* wall2 = new Rectangle(glm::dvec3(0, -6, 5), glm::dvec3(10, -6, 5), glm::dvec3(10, -6, -5), glm::dvec3(0, -6, -5), glm::dvec3(0.0, 1.0, 1.0), 2, 0, true);
	...
	Rectangle* wall5 = new Rectangle(glm::dvec3(0, 6, 5), glm::dvec3(0, 6, -5), glm::dvec3(10, 6, -5), glm::dvec3(10, 6, 5), glm::dvec3(0.0, 1.0, 1.0), 2, 0, true);
