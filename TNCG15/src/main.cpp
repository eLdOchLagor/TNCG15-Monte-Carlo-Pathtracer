...
int main()
{
	...
	Sphere* sphere2 = new Sphere(glm::dvec3(10, 0, -3.5), 1.5, glm::dvec3(0.5, 0.2, 0.8), 3, 0.0); 
	...
	//Lights ----------------------------------------------------------------------------------------
	Rectangle* light1 = new Rectangle(glm::dvec3(2, -2, 4.99), glm::dvec3(2, 2, 4.99), glm::dvec3(5, 2, 4.99), glm::dvec3(5, -2, 4.99), glm::dvec3(1.0, 1.0, 1.0), 0, 0, true);
